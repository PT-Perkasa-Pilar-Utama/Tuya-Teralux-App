...
object SummaryUtils {
    fun loadAndFormatSummary(context: Context, language: String): String {
        return try {
            val content = context.assets.open("summaries.md").bufferedReader().use { it.readText() }
