...
interface RagRepository {
    suspend fun translateAsync(text: String, targetLang: String, token: String): Flow<Resource<String>> // Returns Task ID
    suspend fun pollTranslation(taskId: String, token: String): Flow<Resource<String>> // Returns Translated Text

    suspend fun generateSummaryAsync(text: String, style: String, context: String?, token: String): Flow<Resource<String>> // Returns Task ID
