package com.example.whisperandroid.presentation.summary
...
class SummaryViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val mqttStatus: StateFlow<
        com.example.whisperandroid.utils.MqttHelper.MqttConnectionStatus
        > = _mqttStatus
    ...
    fun sendEmail(
        ...
        viewModelScope.launch {
            val sendEmailUseCase =
                com.example.whisperandroid.data.di.NetworkModule.sendEmailUseCase
    ...
    fun sendEmailByMac(
        ...
        viewModelScope.launch {
            val sendEmailByMacUseCase =
                com.example.whisperandroid.data.di.NetworkModule.sendEmailByMacUseCase
