# ENDPOINT: GET /api/terminal/:id

## Description
Retrieve a single Terminal device by its unique ID.

## Test Scenarios

### 1. Get Terminal By ID (Success)
- **URL**: `http://localhost:8080/api/terminal/t1`
- **Method**: `GET`
- **Headers**:
```json
{
...
- **URL**: `http://localhost:8080/api/terminal/unknown-id`
- **Method**: `GET`
- **Headers**:
```json
{
...
- **URL**: `http://localhost:8080/api/terminal/INVALID-FORMAT`
- **Method**: `GET`
- **Headers**:
```json
{
