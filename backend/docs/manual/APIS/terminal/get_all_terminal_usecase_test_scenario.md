...
## Description
Retrieve a paginated list of all Terminal devices, with optional filtering.

## Test Scenarios

### 1. Get All Terminal (Success - Empty List)
- **URL**: `http://localhost:8080/api/terminal`
- **Method**: `GET`
- **Headers**:
```json
{
...
- **URL**: `http://localhost:8080/api/terminal?page=2&limit=5`
- **Method**: `GET`
- **Headers**:
```json
{
...
### 4. Filter: By Room ID
- **URL**: `http://localhost:8080/api/terminal?room_id=room-101`
- **Method**: `GET`
- **Headers**:
```json
{
...
```json
{
  ...
  "message": "Terminal list retrieved successfully",
  "data": {
    "terminal": [ ... ], // Only devices with room_id=room-101
    "total": 3
  }
}
```
