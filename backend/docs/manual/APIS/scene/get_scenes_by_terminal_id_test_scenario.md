# ENDPOINT: GET /api/terminal/:id/scenes

## Description
Retrieve all scenes configured for a specific Terminal device. Each scene includes its full list of actions.
...
## Parameters
- `id` (path, required): Terminal device UUID

## Test Scenarios

### 1. Success - Get All Scenes with Actions
- **URL**: `http://localhost:8081/api/terminal/<id>/scenes`
- **Method**: `GET`
