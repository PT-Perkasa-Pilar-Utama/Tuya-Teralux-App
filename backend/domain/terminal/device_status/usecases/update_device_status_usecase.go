...
func NewUpdateDeviceStatusUseCase(repo device_status_repositories.IDeviceStatusRepository, devRepo device_repositories.IDeviceRepository, tuyaCmd TuyaDeviceControlExecutor) *UpdateDeviceStatusUseCase {
