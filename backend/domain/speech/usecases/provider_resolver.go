...
type providerResolverImpl struct {
	...
	geminiService *speechSvc.GeminiService
	openaiService *speechSvc.OpenAIService
	groqService   *speechSvc.GroqService
	orionService  *speechSvc.OrionService
...
func GetProviderServices(cfg *utils.Config) (
	*speechSvc.GeminiService,
	*speechSvc.OpenAIService,
	*speechSvc.GroqService,
	*speechSvc.OrionService,
) {
	geminiService := speechSvc.NewGeminiService(cfg)
	openaiService := speechSvc.NewOpenAIService(cfg)
	groqService := speechSvc.NewGroqService(cfg)
	orionService := speechSvc.NewOrionService(cfg)
