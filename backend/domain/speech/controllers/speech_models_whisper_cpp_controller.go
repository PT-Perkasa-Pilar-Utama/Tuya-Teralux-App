...
type SpeechModelsWhisperCppController struct {
	usecase       usecases.TranscribeWhisperCppModelUseCase
	saveRecording recordingUsecases.SaveRecordingUseCase
	config        *utils.Config
}

func NewSpeechModelsWhisperCppController(
	usecase usecases.TranscribeWhisperCppModelUseCase,
	saveRecording recordingUsecases.SaveRecordingUseCase,
	cfg *utils.Config,
) *SpeechModelsWhisperCppController {
	return &SpeechModelsWhisperCppController{
		usecase:       usecase,
...
// Transcribe handles POST /api/speech/models/whisper/cpp
...
// @Router /api/speech/models/whisper/cpp [post]
func (c *SpeechModelsWhisperCppController) Transcribe(ctx *gin.Context) {
