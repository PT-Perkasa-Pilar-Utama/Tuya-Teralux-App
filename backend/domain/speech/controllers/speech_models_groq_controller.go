...
type SpeechModelsGroqController struct {
	usecase       usecases.TranscribeGroqModelUseCase
	saveRecording recordingUsecases.SaveRecordingUseCase
	config        *utils.Config
}

func NewSpeechModelsGroqController(
	usecase usecases.TranscribeGroqModelUseCase,
	saveRecording recordingUsecases.SaveRecordingUseCase,
	cfg *utils.Config,
) *SpeechModelsGroqController {
	return &SpeechModelsGroqController{
		usecase:       usecase,
...
// Transcribe handles POST /api/speech/models/groq
