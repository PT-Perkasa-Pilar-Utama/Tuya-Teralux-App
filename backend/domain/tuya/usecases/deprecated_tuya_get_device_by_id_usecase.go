...
type TuyaGetDeviceByIDUseCaseDeprecated struct {
...
func NewTuyaGetDeviceByIDUseCaseDeprecated(service *services.TuyaDeviceService, deviceStateUC *DeviceStateUseCase) *TuyaGetDeviceByIDUseCaseDeprecated {
	return &TuyaGetDeviceByIDUseCaseDeprecated{
		service:       service,
...
func (uc *TuyaGetDeviceByIDUseCaseDeprecated) GetDeviceByID(accessToken, deviceID string) (*dtos.TuyaDeviceDTO, error) {
	// Cache check removed.
