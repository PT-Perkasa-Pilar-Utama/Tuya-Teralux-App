...
type WhisperModelsOrionController struct {
	usecase       usecases.TranscribeOrionModelUseCase
	saveRecording recordingUsecases.SaveRecordingUseCase
	config        *utils.Config
}

func NewWhisperModelsOrionController(
	usecase usecases.TranscribeOrionModelUseCase,
	saveRecording recordingUsecases.SaveRecordingUseCase,
	cfg *utils.Config,
) *WhisperModelsOrionController {
	return &WhisperModelsOrionController{
		usecase:       usecase,
...
// @Router /api/whisper/models/orion [post]
func (c *WhisperModelsOrionController) Transcribe(ctx *gin.Context) {
