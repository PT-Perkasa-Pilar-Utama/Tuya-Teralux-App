...
type WhisperModelsGroqController struct {
	usecase       usecases.TranscribeGroqModelUseCase
	saveRecording recordingUsecases.SaveRecordingUseCase
	config        *utils.Config
}

func NewWhisperModelsGroqController(
	usecase usecases.TranscribeGroqModelUseCase,
	saveRecording recordingUsecases.SaveRecordingUseCase,
	cfg *utils.Config,
) *WhisperModelsGroqController {
	return &WhisperModelsGroqController{
		usecase:       usecase,
...
// @Router /api/whisper/models/groq [post]
func (c *WhisperModelsGroqController) Transcribe(ctx *gin.Context) {
